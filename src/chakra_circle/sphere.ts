...
function windowResized() {
    ...
    var canvas_scale = Math.min(
        screen_size.x / 1,
        screen_size.y / render_aspect,
    );
    ...
    render_range = [
        center
            .copy()
            .add(
                v(1, render_aspect).mult(-((canvas_scale * canvas_cover) / 2)),
            ),
        center
            .copy()
    ...
    cap_render_range = [
        center
            .copy()
            .add(
                v(1, cap_aspect).mult(-((cap_canvas_scale * canvas_cover) / 2)),
            ),
        center
            .copy()
